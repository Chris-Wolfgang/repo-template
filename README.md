...
3. **Create Setup Branch** - Create a new branch named `Setup` This branch will be used to continue setting up the repo. Because you just configured branch protections in the previous steps you will not be able to commit dirctly to main. Once you are done with the next several steps you will merge this branch to main via a pull request.
