...
> **\* NOTE:** The README.md file for repo-template repository will be replaced by the README-TEMPLATE.md when you run the setup (setup.ps1 or setup.sh). The README-TEMPLATE.md file will be a customized starter README.md file for your repository.
