...
3. **Run automated setup and follow the prompts** - This will prompt you for some values and others it will pull from your project. This will then replace all placeholders with your project information:
   ```bash
