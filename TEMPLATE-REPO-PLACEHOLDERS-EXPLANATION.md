...
The PowerShell setup script (`scripts/setup.ps1`) prompts users for this information:
...
The PowerShell setup script validates that these placeholders are properly replaced (along with other core placeholders) before completing:
